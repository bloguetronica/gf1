/* GF1 Clear Command - Version 2.0 for Debian Linux
    ...
    else  // If libusb is initialized
    {
        ...
        else  // If the device is successfully opened and a handle obtained
        {
            ...
            else  // If the interface is successfully claimed
            {
                ...
                clear_registers(devhandle);  // Clear all waveform generation registers (by sending a specific sequence of bytes to the AD5932 waveform generator on channel 0)
                ...
                set_amplitude(devhandle, 0);  // Set the amplitude to zero (by sending a byte with value 0x00 to the AD5160BRJZ5 SPI potentiometer on channel 1)
