/* GF1 Sine Command - Version 3.0 for Debian Linux
...
int main(int argc, char **argv)
{
    ...
    if (err == GF1Device::SUCCESS) {  // Device was successfully opened
        ...
        device.setSineWave(errcnt, errstr);  // Set the waveform of the generated signal to sinusoidal
        if (errcnt > 0) {  // In case of error
            ...
            std::cout << "Waveform set to sinusoidal." << std::endl;
        }
        device.close();
