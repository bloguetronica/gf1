...
cp -f src/common.c /usr/local/src/gf1/.
cp -f src/common.h /usr/local/src/gf1/.
cp -f src/gf1-amp.c /usr/local/src/gf1/.
cp -f src/gf1-amp50.c /usr/local/src/gf1/.
cp -f src/gf1-clear.c /usr/local/src/gf1/.
cp -f src/gf1-core.c /usr/local/src/gf1/.
cp -f src/gf1-core.h /usr/local/src/gf1/.
cp -f src/gf1-freq.c /usr/local/src/gf1/.
cp -f src/gf1-list.c /usr/local/src/gf1/.
...
cp -f man/gf1-list.1.gz /usr/local/share/man/man1/.
